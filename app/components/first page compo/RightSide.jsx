...
function RightSide() {
  ...
  return (
    <div className="p-4 mt-6 overflow-hidden text-center md:p-2 md:h-screen md:mt-0 md:flex md:flex-col md:justify-center xl:px-20">
      <h2 className="text-xl font-bold md:text-2xl">Get started</h2>

      <div className="flex items-center justify-center gap-3 my-4">
        <Button onClick={handleLoginClick} fullWidth>
          Log in
        </Button>
        <Button onClick={handleSignUpClick} fullWidth>
          Sign Up
        </Button>
      </div>

      <div className="flex flex-col items-center justify-center mt-8 md:translate-y-52 ">
        <svg
          viewBox="0 0 1180 320"
          className="h-[22px] w-auto opacity-20"
        >
